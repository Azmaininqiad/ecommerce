...
//start edit2: Added state management and signin functionality
const Signin = () => {
            ...
            <div>
              ...
              {/* end edit3 */}
                <div className="mb-5">
                  ...
                  {/* start edit4: Added controlled input for email */}
                  <input
                    type="email"
                    name="email"
                    id="email"
                ...
                <div className="mb-5">
                  ...
                  {/* start edit5: Added controlled input for password */}
                  <input
                    type="password"
                    name="password"
                    id="password"
                ...
                {/* start edit6: Added loading state and disabled button */}
                <button
                  type="submit"
                  disabled={loading}
                ...
                {/* start edit7: Added password reset functionality */}
                <button
                  type="button"
                  onClick={async () => {
                    if (!email) {
