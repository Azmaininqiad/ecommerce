...
const ShopDetails = () => {
  ...
  const productIdStr = pathname.split('/').pop(); // Gets the last segment of the URL
          ...
          <div className="flex flex-col lg:flex-row gap-7.5 xl:gap-17.5">
            <div className="lg:max-w-[570px] w-full">
              ...
              <div className="flex flex-wrap sm:flex-nowrap gap-4.5 mt-6">
                {product.imgs?.thumbnails.map((item, key) => item && (
                  <button
                  ...
                  >
                    <Image width={50} height={50} src={item} alt={`Product thumbnail ${key + 1}`} />
                  </button>
                ))}
              </div>
            </div>
            ...
            <div className="max-w-[539px] w-full">
                ...
                <div className="flex items-center gap-2.5">
                  <div className="flex items-center gap-1">
                    {[1, 2, 3, 4, 5].map((_, index) => (
                      <span key={index} className="cursor-pointer text-[#FBB040]">
                        <svg
                          className="fill-current"
                          width="18"
                          height="18"
              ...
              <h3 className="font-medium text-custom-1 mb-4.5">
                <span className="text-sm sm:text-base text-dark">
                  Price: {product.discounted_price} BDT
                </span>
                <span className="line-through"> {product.price} BDT</span>
              </h3>
      ...
      <section className="overflow-hidden bg-gray-2 py-20">
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          ...
          <div className="bg-white rounded-[10px] shadow-1 p-6 mb-8">
            <h2 className="font-medium text-2xl text-dark mb-4">Description</h2>
            <div className="h-[25vh] overflow-y-auto">
              <div className="max-w-full">
                ...
                <h3 className="font-medium text-xl text-dark my-4">
                  Product Description
                </h3>
                <p className="mb-6">
          ...
          <div className="bg-white rounded-[10px] shadow-1 p-6">
            <h2 className="font-medium text-2xl text-dark mb-4">Reviews</h2>
